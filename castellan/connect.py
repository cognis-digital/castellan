"""Native cognis-connect emit for castellan — forward findings to any platform.

Maps castellan's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    castellan ... --format json | castellan-emit --to stix
    castellan-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
