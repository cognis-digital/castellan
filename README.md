...
[![PyPI](https://img.shields.io/pypi/v/cognis-threatmodeler.svg)](https://pypi.org/project/cognis-threatmodeler/)
[![CI](https://github.com/cognis-digital/threatmodeler/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/threatmodeler/actions)
...
THREATMODELER exists for one job — generate stride threat models and attack trees from a yaml system spec. — and does it without a SaaS bill or heavyweight setup.
...
threatmodeler scan .                      # scan the current project
threatmodeler scan . --format json
threatmodeler scan . --fail-on high       # non-zero exit for CI gates
threatmodeler mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **OWASP Threat Dragon / pytm**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`threatmodeler` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
