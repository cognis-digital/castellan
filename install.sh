#!/usr/bin/env sh
# Universal installer for castellan. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/castellan.git"
echo "Installing castellan ..."
