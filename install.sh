#!/usr/bin/env sh
# Universal installer for threatmodeler. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/threatmodeler.git"
echo "Installing threatmodeler ..."
...
echo "Done. Run: threatmodeler --help"
